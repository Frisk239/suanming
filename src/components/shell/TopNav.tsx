...
export function TopNav() {
  return (
    <header className="sticky top-0 z-50 hidden md:flex items-center justify-between px-6 h-14 border-b border-dai-qing/[0.05] bg-xuan-zhi-warm/85 backdrop-blur-xl">
